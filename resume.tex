...
Auburn, AL 36832 & https://mattboler.github.io/\\
\end{tabular*}
\\
...
\begin{itemize}
\item
	\ressubheading{Auburn University}{Auburn, AL}{M.S., Mechanical Engineering (Thesis Option)}{May 2019 - August 2021}
	\begin{itemize}
		\resitem{Thesis: }
		\resitem{Graduated with \textbf{3.86} cumulative GPA.}
		\resitem{Relevant courses: Optimal Control and Estimation, Nonlinear Systems and Control, Digital Image Processing, Probability and Stochastic Processes}
	\end{itemize}

\item
	\ressubheading{Auburn University}{Auburn, AL}{B.S. Mechanical Engineering, Computer Science Minor}{2014-2019}
	\begin{itemize}
		\resitem{Graduated with Honors, \textbf{3.56} cumulative GPA.}
	\end{itemize}
